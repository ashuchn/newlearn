...
@section('title','Create Daily Quiz')
@section('css')
                                ...
                                <form action="{{ route('quiz.save') }}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" name="quiz_name" value="{{ old('quiz_name') }}" placeholder="Enter Quiz Name" class="form-control" id="quiz_name">
                                        </div>
                                        <div class="form-group col-md-6">
